...
const Footer = () =>{
    ...
    return (
        ...
        <motion.footer initial={{y:100, opacity:0}} whileInView={{y:0, opacity:1}} transition={{ease:"easeIn", duration:1}}  className="m-auto py-20">
                            ...
                            {cvLinks.map((link, index) => (
                                <a
                                    ...
                                    className={`flex w-45 h-10 items-center justify-center lg:gap-2 p-2 lg:px-6 lg:py-3 rounded-lg font-medium transition-all duration-300 ${
                                        ...
                                        ? "bg-linear-to-r from-cyan-600 to-cyan-700 text-white hover:from-cyn-700 hover:to-cyan-800 shadow-lg hover:shadow-cyan-500/25"
                    ...
                    <div className="flex justify-center gap-3">
                        {socialMedia.map((social, index) => (
                            <a
                                ...
                                className="p-3 bg-linear-to-b from-blue-900 to-blue-950 border-2 border-blue-700/80 rounded-full hover:bg-gray-700 hover:text-white transition-all duration-300 hover:scale-110 hover:shadow-lg"
                            >
            ...
            <div className="w-4/5 m-auto border-t border-blue-400 pt-8">
