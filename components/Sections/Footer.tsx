...
const cvLinks = [
    {
        icon: <FiFileText />,
        text: "View CV",
        href: "Joriel Brian Sudario - CV.pdf",
        variant: "outline"
    },
    {
        icon: <FiDownload />,
...
const socialMedia = [
    {
        icon: <FiFacebook />,
        href: "https://www.facebook.com/jorielbrian.sudario?mibextid=ZbWKwL",
        label: "Facebook"
    },
    {
        icon: <FiGithub />,
        href: "https://github.com/JorielBrian",
        label: "GitHub"
    },
    {
        icon: <FiLinkedin />,
        href: "https://www.linkedin.com/in/joriel-brian-sudario-b14728265",
        label: "LinkedIn"
    },
    {
        icon: <FiInstagram />,
        href: "https://instagram.com/jorielbrian?igshid=MzNlNGNkZWQ4Mg==",
        label: "Instagram"
    }
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div className="space-y-3">
                        {contactInfo.map((item, index) => (
                            ...
                            >
                                <span className="text-blue-400 group-hover:text-blue-200 text-lg">
                                    {item.icon}
                                </span>
            ...
            >
                ...
                <p className="text-gray-500 text-xs">
                    Built with Next.js, TypeScript, Python, FastAPI, PostgreSQL, and more.
                </p>
            </motion.div>
